...
class TimesheetEntriesListDisplay : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = MyAdapter(TimesheetEntriesList.getEntriesList(),this)
    ...
    class ItemViewHolder(itemView: View, private val listener: OnItemClickListener) : RecyclerView.ViewHolder(itemView) {
    ...
    class MyAdapter(private val data: List<TimesheetEntry>, private val activity: Activity) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
            ...
            return ItemViewHolder(view, object:OnItemClickListener
            {
